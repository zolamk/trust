use crate::{
    ...
    handlers::provider::{FacebookProvider, GithubProvider, GoogleProvider, Provider, ProviderState},
...
pub fn callback(config: State<Config>, connection_pool: State<Pool<ConnectionManager<PgConnection>>>, code: String, state: String) -> Redirect {
