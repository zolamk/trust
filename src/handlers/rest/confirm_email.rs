use crate::{
    handlers::{lib::confirm_email, Error},
...
#[post("/confirm/email", data = "<confirm_form>")]
pub fn confirm(
    connection_pool: State<Pool<ConnectionManager<PgConnection>>>,
    confirm_form: Json<confirm_email::ConfirmForm>,
    ...
    let user = confirm_email::confirm(&connection, confirm_form.into_inner());
